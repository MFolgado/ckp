...
class OrderServicesControllerTest < ActionController::TestCase
  ...
  test "should create order_service" do
    assert_difference('OrderService.count') do
      post :create, order_service: { client_id: @order_service.client_id, part_id: @order_service.part_id, service_id: @order_service.service_id }
    end
  ...
  test "should update order_service" do
    patch :update, id: @order_service, order_service: { client_id: @order_service.client_id, part_id: @order_service.part_id, service_id: @order_service.service_id }
    assert_redirected_to order_service_path(assigns(:order_service))
  end
